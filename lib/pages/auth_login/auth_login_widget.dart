...
class _AuthLoginWidgetState extends State<AuthLoginWidget>
  ...
  void initState() {
    ...
    _model.nitTextController ??= TextEditingController(text: FFAppState().Nit);
                                        ...
                                        children: [
                                          Expanded(
                                            child: Padding(
                                              ...
                                              child: TextFormField(
                                                controller:
                                                    _model.nitTextController,
                                                focusNode: _model.nitFocusNode,
                                                autofocus: true,
                                                textCapitalization:
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          _model.apiResultLogin =
                                              await AuthGroup.loginUserCall
                                                  .call(
                                            identification:
                                                _model.nitTextController.text,
                                            email: _model
                                                .emailAddressTextController
                                                .text,
                                            password: _model
                                          ...
                                          if ((_model
                                            ...
                                            if ((_model.apiResultdUser
                                                    ?.succeeded ??
                                                true)) {
                                              FFAppState().dataEmploye =
                                                  EmployeeStruct.maybeFromMap(
                                                      getJsonField(
                                                (_model.apiResultdUser
                                                        ?.jsonBody ??
                                                    ''),
