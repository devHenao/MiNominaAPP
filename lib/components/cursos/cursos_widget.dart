...
class CursosWidget extends StatefulWidget {
  ...
  final ListTrainingEmployeeStruct? curso;
...
class _CursosWidgetState extends State<CursosWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResultCursos =
          await AppEmployeeGroup.getListTrainingEmployeeCall.call(
        token: FFAppState().token,
      );

      if ((_model.apiResultCursos?.succeeded ?? true)) {
        _model.dCursos = ListTrainingEmployeeStruct.maybeFromMap(getJsonField(
          widget.curso?.toMap(),
          r'''$.success''',
        ));
        safeSetState(() {});
          ...
          builder: (alertDialogContext) {
            return AlertDialog(
              ...
              content: Text(getJsonField(
                (_model.apiResultCursos?.jsonBody ?? ''),
                r'''$.success''',
              ).toString().toString()),
              actions: [
                TextButton(
