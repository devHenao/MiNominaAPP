...
class ListCurrentStruct extends BaseStruct {
  ListCurrentStruct({
    String? asunto,
    String? consecutivo,
    String? de,
  ...
  static ListCurrentStruct fromMap(Map<String, dynamic> data) =>
      ListCurrentStruct(
  ...
  static ListCurrentStruct? maybeFromMap(dynamic data) => data is Map
      ? ListCurrentStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static ListCurrentStruct fromSerializableMap(Map<String, dynamic> data) =>
      ListCurrentStruct(
  ...
  @override
  String toString() => 'ListCurrentStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is ListCurrentStruct &&
        asunto == other.asunto &&
...
ListCurrentStruct createListCurrentStruct({
  String? asunto,
  String? consecutivo,
  String? de,
  String? dependencia,
